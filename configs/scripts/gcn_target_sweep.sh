...
#BSUB -o batch/logs/gcn_target_sweep_%J.out
#BSUB -e batch/logs/gcn_target_sweep_%J.err
...
RESULTS_JSON="${RESULTS_JSON:-${REPO_ROOT}/outputs/gcn_target_sweep_results.json}"
PLOT_PATH="${PLOT_PATH:-${REPO_ROOT}/outputs/gcn_target_sweep_loss.png}"
